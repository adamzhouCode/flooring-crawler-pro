...
INDUSTRY_PRESETS = {
    "地板批发/工厂 (Wholesale)": {
        "query": '"{city}" 地板 批发 联系电话 -1688.com -alibaba.com',
        "persona": "高级采购经理",
        "focus": "寻找当地地板批发商和工厂的官网，关注库存能力、工厂直发、品牌代理资质和联系方式。"
    },
    "房地产开发商 (Developers)": {
        "query": '"{city}" 房地产开发 集团 官网 联系我们',
        "persona": "供应链管理专家",
        "focus": "寻找有在建或规划住宅/商业项目的开发商，关注项目规模、材料采购需求和对接人信息。"
    },
    "装修/设计公司 (Design Firms)": {
        "query": '"{city}" 装饰工程有限公司 地板 OR 地面 案例',
        "persona": "合作伙伴经理",
        "focus": "寻找承接商业或高端住宅装修项目的公司，关注其项目案例中是否涉及地板/地面材料，以及合作联系方式。"
    },
    "地板零售/门店 (Retailers)": {
        "query": '"{city}" 地板 专卖店 OR 展厅 地址 电话',
        "persona": "客户经理",
        "focus": "寻找独立地板零售门店或展厅的官网，关注经营品牌、门店地址和联系方式，评估其经营新品牌的意愿。"
    },
    "建筑工程公司 (Contractors)": {
        "query": '"{city}" 建筑装饰工程 地板铺装 OR 地面工程 承接',
        "persona": "项目合作经理",
        "focus": "寻找承接地板铺装或地面工程的施工企业，关注工程资质、过往项目和材料采购量。"
    }
}
